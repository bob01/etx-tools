...
fields[#fields + 1] = { t = "count",                  x = x + indent, y = inc.y(lineSpacing), sp = x + sp, min = -300, max = 300, ro = true, vals = { 1, 2 } }
...
fields[#fields + 1] = { t = "P-Gain",                 x = x + indent, y = inc.y(lineSpacing), sp = x + sp, min = -300, max = 300, ro = true, vals = { 11, 12 } }
fields[#fields + 1] = { t = "I-Gain",                 x = x + indent, y = inc.y(lineSpacing), sp = x + sp, min = -300, max = 300, ro = true, vals = { 13, 14 } }
...
fields[#fields + 1] = { t = "Stick Zero (us)",        x = x + indent, y = inc.y(lineSpacing), sp = x + sp, min = -300, max = 300, ro = true, vals = { 35, 36 } }
fields[#fields + 1] = { t = "Stick Range (us)",       x = x + indent, y = inc.y(lineSpacing), sp = x + sp, min = -300, max = 300, ro = true, vals = { 37, 38 } }
fields[#fields + 1] = { t = "PWM Rate (us)",          x = x + indent, y = inc.y(lineSpacing), sp = x + sp, min = -300, max = 300, ro = true, vals = { 39, 40 } }
fields[#fields + 1] = { t = "Motor Pole Pairs",       x = x + indent, y = inc.y(lineSpacing), sp = x + sp, min = -300, max = 300, ro = true, vals = { 41, 42 } }
fields[#fields + 1] = { t = "Pinion Teeth",           x = x + indent, y = inc.y(lineSpacing), sp = x + sp, min = -300, max = 300, ro = true, vals = { 43, 44 } }
fields[#fields + 1] = { t = "Main Teeth",             x = x + indent, y = inc.y(lineSpacing), sp = x + sp, min = -300, max = 300, ro = true, vals = { 45, 46 } }
fields[#fields + 1] = { t = "Min Start Power",        x = x + indent, y = inc.y(lineSpacing), sp = x + sp, min = -300, max = 300, ro = true, vals = { 47, 48 } }
fields[#fields + 1] = { t = "Max Start Power",        x = x + indent, y = inc.y(lineSpacing), sp = x + sp, min = -300, max = 300, ro = true, vals = { 49, 50 } }
...
fields[#fields + 1] = { t = "Batt Current Limit",     x = x + indent, y = inc.y(lineSpacing), sp = x + sp, min = -300, max = 300, ro = true, vals = { 55, 56 } }
